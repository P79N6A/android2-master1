...
public class ElaborateCourseAdapter extends RecyclerView.Adapter<ElaborateCourseAdapter.CourseViewHolder> {
    private Activity mContext;
    private List<MainCourseEntity.CourseBean.ElaborateCourseBean.CourseDetailBean> mCourseDetails;
    private LayoutInflater mLayoutInflater;

    public ElaborateCourseAdapter(Activity mContext, List<MainCourseEntity.CourseBean.ElaborateCourseBean.CourseDetailBean> mCourseDetails) {
