...
public class SuperiorDetailAdapter extends CommonAdapter {
    ...
    public SuperiorDetailAdapter(Context context) {
        super(context);
        this.context = context;
    }

    public SuperiorDetailAdapter(Context context, List mDatas) {
        ...
        if (position + 1 < mDatas.size()) {
            ...
            rlayout_two.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putSerializable("kcBean", (Serializable) kcBean);
